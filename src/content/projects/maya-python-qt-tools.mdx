...
thumbnail: '/images/projects/maya-python-qt-tools/kitty-city-example.png'
role: 'Sole Designer'
priority: 50
year: 2023
filters: ['utility']
...
<ImageEmbed file="maya-python-qt-tools/kitty-city-example.png" />
...
<ImageEmbed file="maya-python-qt-tools/tool.png" />
...
<CodeSnippet title="Example.cs" lang="Python">
```python
def run():
